  ...
  <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
      ...
      <div class="mx-auto mt-10">
        <table id="table_accounts" style="width:100%;background-color: #444;" class="w-full text-sm text-left text-gray-200 dark:text-gray-400">
          <thead>
            <tr>
              <th scope="col" class="px-6 py-4 text-white"><span>№</span></th>
              <th scope="col" class="px-6 py-4 text-white"><span>{{ __('messages.lk_table_dashboardchars_name_char') }}</span></th>
              <th scope="col" class="px-6 py-4 text-white"><span>{{ __('messages.lk_table_dashboardchars_name_account') }}</span></th>
              <th scope="col" class="px-6 py-4 text-white"><span>{{ __('messages.lk_table_dashboardchars_name_server') }}</span></th>
              <th scope="col" class="px-6 py-4 text-white"><span>{{ __('messages.lk_table_dashboardchars_lvl') }}</span></th>
              <th scope="col" class="px-6 py-4 text-white"><span>{{ __('messages.lk_table_dashboardchars_clan_name') }}</span></th>
              <th scope="col" class="px-6 py-4 text-white"><span>{{ __('messages.lk_table_dashboardchars_pvp') }}</span></th>
              <th scope="col" class="px-6 py-4 text-white"><span>{{ __('messages.lk_table_dashboardchars_pk') }}</span></th>
              <th scope="col" class="px-6 py-4 text-white"><span>{{ __('messages.lk_table_dashboardchars_last_data') }}</span></th>
              <th scope="col" class="px-6 py-4 text-white"><span>{{ __('messages.lk_table_dashboardchars_online') }}</span></th>
              <th scope="col" class="px-6 py-4 text-white"><span>{{ __('messages.lk_table_dashboardchars_promo') }}</span></th>
            </tr>
          </thead>
          <tbody>
            @if(isset($arrayInfoDashboardChars))
              @foreach($arrayInfoDashboardChars as $model)
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 text-gray-500">
                  <td data-label="№"  class="px-6 py-4 text-black">{{ $model->id }}</td>
                  <td data-label="{{ __('messages.lk_table_dashboardchars_name_char') }}" class="px-6 py-4 text-black">{{ $model->char_name }}</td>
                  <td data-label="{{ __('messages.lk_table_dashboardchars_name_account') }}" class="px-6 py-4 text-black">{{ $model->account_name }}</td>
                  <td data-label="{{ __('messages.lk_table_dashboardchars_name_server') }}" class="px-6 py-4 text-black">{{ $model->server_name }}</td>
                  <td data-label="{{ __('messages.lk_table_dashboardchars_lvl') }}" class="px-6 py-4 text-black">{{ $model->lvl }}</td>
                  <td data-label="{{ __('messages.lk_table_dashboardchars_clan_name') }}" class="px-6 py-4 text-black">{{ $model->clan_name }}</td>
                  <td data-label="{{ __('messages.lk_table_dashboardchars_pvp') }}" class="px-6 py-4 text-black">{{ $model->pvp }}</td>
                  <td data-label="{{ __('messages.lk_table_dashboardchars_pk') }}" class="px-6 py-4 text-black">{{ $model->pk }}</td>
                  <td data-label="{{ __('messages.lk_table_dashboardchars_last_data') }}" class="px-6 py-4 text-black">{{ $model->last_data }}</td>
                  <td data-label="{{ __('messages.lk_table_dashboardchars_online') }}" class="px-6 py-4 text-black">{{ $model->online }}</td>
                  <td data-label="{{ __('messages.lk_table_dashboardchars_promo') }}" class="px-6 py-4 text-black">
                    <a href="#" onclick='return openDialogPromo("{{ $model->account_name }}", "{{ $model->char_name }}", "{{ $model->server_name }}")' class="button19 font-medium text-blue-600 dark:text-blue-500 hover:underline">{{ __('messages.lk_table_dashboardchars_promo_actvate') }}</a>
                  </td>
                </tr>
              @endforeach
            @else
              <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                <td colspan="11" class="px-6 py-4 text-center font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ __('messages.lk_no_data') }}</td>
              </tr>
            @endif
          </tbody>
        </table>
