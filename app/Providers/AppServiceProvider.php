...
use App\Service\InterkassaService; // Подключаем класс
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        // Регистрация InterkassaService
        $this->app->singleton(InterkassaService::class, function ($app) {
            return new InterkassaService();
        });
    }
