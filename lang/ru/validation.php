...
return [
    ...
    */
    'newsBlock' => "Новости",
    'success' => "Поздравляем! Вы зарегистрировали аккаунт!",
    'email_send' => "Вам отправлено письмо для активации! Если письмо не пришло в течении 3 минут проверьте папку Спам.",
    'accepted' => 'The :attribute must be accepted.',
    'enter_server_db' => "Выбранный сервер не найден",
    'enter_use_db' => "На выбранном сервер есть такой юзер",
    'text_policy_agree' => "Нажимая на кнопку регистрации я соглашаюсь с",
    ...
    'confirmed' => 'Не верный пароль подтверждения!',
    ...
    'required' => 'The :attribute field is required. Введите капчу.',
    ...
    'enot_url_error' => 'Проблемы с сервером попробуйте повторить позже!',
    ...
    'admin_additems_account_name' => 'account name не прошла проверку',
